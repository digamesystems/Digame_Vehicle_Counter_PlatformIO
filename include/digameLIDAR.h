...
int processLIDARSignal3(Config config)
{
  ...
  //unsigned int lidarUpdateRate = 20; // Time in ms between readings
...
Call this function and it will grab a lidar reading and return whatever you want. 

 ****************************************************************************************/
int processLIDARSignal4(Config config, int desiredReturnValue)
{
  // LIDAR signal analysis parameters
  ...
  int retValue = desiredReturnValue; // Return value for the routine. 
                                     // Do we have a vehicle event?
                                     // Which lane?
  return retValue;
}
